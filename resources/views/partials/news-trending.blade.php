...
<<<<<<< HEAD
		<div class="news-item trending image" style="background-image:url({{URL::asset($article->image)}})"></div>
=======
		<div class="news-item trending image" style="background-image:url(../{{$article->image}})"></div>
>>>>>>> 51d5d5773422ce4a1690c9045b5a30f67f8c826d
